...
const seedData = [
  ...
  //   name: 'Die Hard',
  //   year: '1987',
  //   review: `A must-see if you like action maleProposals.`,
  ...
  //   privateComments: `Terminator is my favorite maleProposal ever. `
  // },
  // {
  //   name: 'Jaws',
  //   year: '1971',
...
Meteor.startup(function () {
  ...
  if (MaleProposals.find().fetch().length === 0) {
    console.log('// creating dummy maleProposals');
    seedData.forEach(document => {
      newMutation({
        action: 'maleProposals.new',
